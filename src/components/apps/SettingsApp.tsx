...
export default function SettingsApp() {
  ...
  return (
    <div className="flex h-full w-full bg-zinc-950 text-white overflow-hidden">
      {/* Settings Sidebar */}
      <div className="w-64 border-r border-white/5 bg-black/20 p-4 space-y-2 shrink-0">
        ...
        <div className="max-w-3xl mx-auto space-y-8">
                 ...
                 <div className="space-y-1">
                   <div className="flex items-center justify-between p-4 rounded-xl bg-white/5 border border-white/5">
                      ...
                      <button
                        ...
                        className={`w-10 h-5 rounded-full transition-colors relative ${transparency ? 'bg-blue-600' : 'bg-zinc-700'}`}
                      >
                   ...
                   <div className="flex items-center justify-between p-4 rounded-xl bg-white/5 border border-white/5">
                      ...
                      <button
                        ...
                        className={`w-10 h-5 rounded-full transition-colors relative ${reduceMotion ? 'bg-blue-600' : 'bg-zinc-700'}`}
                      >
                        ...
                        <div>
                          ...
                          {editingName ? (
                            <input
                              ...
                              className="bg-black/40 border border-blue-500/50 rounded px-2 py-0.5 text-[10px] mt-1 outline-none"
                              autoFocus
                              onKeyDown={(e) => e.key === 'Enter' && handleNameSave()}
                            />
                          ) : (
                            <p className="text-[10px] text-zinc-500">Currently: {userName}</p>
                          )}
                        </div>
                      </div>
                      <button
                 ...
                 <div className="space-y-1">
                   ...
                   <div className="flex items-center justify-between p-4 rounded-xl bg-white/5 border border-white/5">
                      ...
                      <button
                        ...
                        className={`w-10 h-5 rounded-full transition-colors relative ${showSeconds ? 'bg-blue-600' : 'bg-zinc-700'}`}
                      >
          ...
          {activeTab === "about" && (
            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
              ...
              <p className="text-[9px] text-center text-zinc-600 px-10 leading-relaxed">
